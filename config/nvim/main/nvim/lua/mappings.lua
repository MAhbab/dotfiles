...
-- Bookmark Manager
map('n', '<Leader>bb', ':BookmarksMark<CR>', {desc = 'Toggle bookmark on current file', noremap = true})
map('n', '<Leader>bn', ':BookmarksNewList<CR>', {desc = 'Create new bookmark list', noremap = true})
map('n', '<Leader>bl', ':BookmarksList<CR>', {desc = 'Browse bookmark lists', noremap = true})
map('n', '<Leader>bc', ':BookmarksCommands<CR>', {desc = 'List bookmark commands', noremap = true})
